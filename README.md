# UI classes for the Booosta PHP Framework

This module provides an abstrace UI class that is used by serveral UI modules. There is usually no need
to use this class directly, despite you want to code your own UI modules for Booosta.
